...
{
	/*
	ship.update(frameTime);    // Rotate ship    
	ship.setDegrees(ship.getDegrees() + frameTime * ROTATION_RATE);     // Make ship smaller    
	ship.setScale(ship.getScale() - frameTime * SCALE_RATE);     ship.setX(ship.getX() + frameTime * SHIP_SPEED);    // Move ship right    
